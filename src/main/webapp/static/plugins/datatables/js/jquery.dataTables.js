...
(/** @lends <global> */function( $ ) {
	 ...
	 *   var sys = $('#example').DataTable();
	 *
	 * @example
	 *   // Initialisation using a DataTables jQuery object
	 *   var sys = $('#example').dataTable().sys();
	 *
	 * @example
	 *   // Initialisation as a constructor
	 *   var sys = new $.fn.DataTable.Api( 'table.dataTable' );
	 */
	...
	DataTable.defaults = {
		 ...
		 * [jQuery.ajax](http://sys.jquery.com/jQuery.ajax/) allowing fine control
		 ...
		 * `dt-sys search()`, providing a delay before the search is made.
		 *  @type integer
		 *  @default 0
		 *
		 *  @dtopt Options
	...
	DataTable.ext = _ext = {
		 ...
		 *    {
		 *      return this.sys().column( col, {order:'index'} ).nodes().map( function ( td, i ) {
		 *        return $('input', td).val();
		 *      } );
		 *    }
		 */
