...
<title>仁禾益美--首页1</title>
<link rel="shortcut icon" href="static/img/abs/favicon.ico" type="image/x-icon"/>
<link href="static/JsCss/common.css" rel="stylesheet" media="screen" type="text/css" />
<script type="text/javascript" src="static/JsCss/jquery-1.4.2.min.js"></script>
    ...
    <div id="cz-center">
        ...
        <div class="index_banner">
            <div class="index_banner_bg">
		       	<div id="showPic" >  
			        <img src="images/1.jpg" id="myPic" style="width:970;height:330"/>  
			    </div>  
            </div>
        </div>
        ...
        <div class="index_3c_k">
            ...
            <div class="c3_2">
                ...
                <div class="c3_2c">
                    ...
                    <div class="pro_s">
                        <ul>
                            <li>
                                <div class="img"><a href="product_show.jsp"><img src="images/pro.png" width="97" height="81" /></a></div>
                                <div class="word">
            ...
            <div class="c3_3">
                ...
                <div class="c3_3c">
					<div class="img"><a href="#"><img src="images/ab.gif" width="103" height="77" /></a></div>
